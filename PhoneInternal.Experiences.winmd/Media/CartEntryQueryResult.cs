...
// Type: PhoneInternal.Experiences.Media.CartEntryQueryResult
...
namespace PhoneInternal.Experiences.Media
{
  ...
  public sealed class CartEntryQueryResult : ICartEntryQueryResult
  {
    ...
    [MethodImpl]
    public extern IAsyncOperation<uint> GetCartEntriesCountAsync();

    [Overload("GetCartEntriesAsync")]
    [MethodImpl]
    public extern IAsyncOperation<IVector<CartEntry>> GetCartEntriesAsync();
