...
// Type: LocationServiceInterop.GEOFENCE_MONITORED_STATES
...
{
  public enum GEOFENCE_MONITORED_STATES
  {
    GEOFENCE_MONITORED_STATES_ENTRY = 1,
    GEOFENCE_MONITORED_STATES_EXIT = 2,
    GEOFENCE_MONITORED_STATES_REMOVAL = 4,
  }
}
