...
// Type: LocationServiceInterop.LOCATIONREQUEST_PERIODICTRACKING
...
namespace LocationServiceInterop
{
  ...
  public struct LOCATIONREQUEST_PERIODICTRACKING
  {
    public LOCATIONREQUEST_ACCURACYTYPE AccuracyType;
    public uint AccuracyValue;
