...
// Type: Microsoft.Phone.Tasks.ShareStatusTask
  ...
  public sealed class ShareStatusTask : ShareTaskBase
  {
    ...
    internal override ParameterPropertyBag BuildParameterPropertyBag()
    {
      ...
      if (!string.IsNullOrEmpty(status))
        parameterPropertyBag.CreateProperty("Body").StringValue = status;
      parameterPropertyBag.CreateProperty("ShareMethod").Int32Value = 11;
