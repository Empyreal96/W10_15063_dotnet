...
// Type: Microsoft.Phone.Tasks.AddressChooserTask
...
namespace Microsoft.Phone.Tasks
{
  public sealed class AddressChooserTask : ChooserBase<AddressResult>
  {
    ...
    internal override ParameterPropertyBag BuildParameterPropertyBag()
    {
      ...
      parameterPropertyBag.CreateProperty("DesiredFields").StringValue = "Address";
    ...
    internal override void OnInvokeReturned(byte[] outputBuffer, Delegate fireThisHandlerOnly)
    {
      ...
      if (outputBuffer.Length != 0)
      {
        ...
        ParameterProperty property = ppb.GetProperty("Address");
        if (property.ValueType == ParameterPropertyValueType.ValueType_String && !string.IsNullOrEmpty(property.StringValue))
        {
          flag = true;
          this.FireCompleted((object) this, new AddressResult(TaskResult.OK)
          {
            Address = property.StringValue,
      ...
      if (flag)
        return;
      this.FireCompleted((object) this, new AddressResult(TaskResult.Cancel), fireThisHandlerOnly);
    }
