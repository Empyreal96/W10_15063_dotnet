...
// Type: Microsoft.Phone.Controls.JumpListItemBackgroundConverter
...
namespace Microsoft.Phone.Controls
{
  public class JumpListItemBackgroundConverter : IValueConverter
  {
    ...
    {
      this.Enabled = (Brush) Application.Current.Resources[(object) "PhoneAccentBrush"];
      this.Disabled = (Brush) Application.Current.Resources[(object) "PhoneChromeBrush"];
    }
