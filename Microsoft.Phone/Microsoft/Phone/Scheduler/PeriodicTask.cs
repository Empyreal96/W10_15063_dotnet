...
// Type: Microsoft.Phone.Scheduler.PeriodicTask
...
namespace Microsoft.Phone.Scheduler
{
  ...
  public sealed class PeriodicTask : ScheduledTask
  {
    ...
    internal PeriodicTask(PeriodicTask periodicAgent)
      : base((ScheduledTask) periodicAgent)
    {
    }

    internal override ScheduledAction CreateCopy() => (ScheduledAction) new PeriodicTask(this);
  }
}
