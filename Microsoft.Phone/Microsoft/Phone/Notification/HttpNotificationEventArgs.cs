...
// Type: Microsoft.Phone.Notification.HttpNotificationEventArgs
...
namespace Microsoft.Phone.Notification
{
  ...
  public class HttpNotificationEventArgs : EventArgs
  {
    ...
    internal HttpNotificationEventArgs(HttpNotification notif) => this.notification = notif;

    public HttpNotification Notification => this.notification;
  }
}
