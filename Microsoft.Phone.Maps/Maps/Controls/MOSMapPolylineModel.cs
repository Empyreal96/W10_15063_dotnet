...
// Type: Microsoft.Phone.Maps.Controls.MOSMapPolylineModel
...
{
  internal class MOSMapPolylineModel : MOSMapObject, IMapPolylineModel, IMapElementModel
  {
    private readonly MapPolylineAdapter adapter;
    private double? strokeThickness;

    public MOSMapPolylineModel() => this.adapter = new MapPolylineAdapter();

    public MapObjectSafeHandle NativeHandle => this.adapter.NativeHandle;
