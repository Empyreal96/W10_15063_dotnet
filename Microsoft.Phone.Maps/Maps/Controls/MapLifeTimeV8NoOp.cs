...
// Type: Microsoft.Phone.Maps.Controls.MapLifeTimeV8NoOp
...
{
  internal class MapLifeTimeV8NoOp : MapLifetime
  {
    public MapLifeTimeV8NoOp(
      Control mapControl,
      MapCallbacks mapInteropCallbacks,
      Dispatcher dispatcher)
    {
      this.MapModel = (IMapModel) new MapModelNoOp(mapInteropCallbacks, dispatcher);
    }
