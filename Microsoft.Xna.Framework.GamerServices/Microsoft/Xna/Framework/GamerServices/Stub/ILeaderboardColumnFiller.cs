...
// Type: Microsoft.Xna.Framework.GamerServices.Stub.ILeaderboardColumnFiller
...
{
  internal interface ILeaderboardColumnFiller
  {
    ...
    void AddColumn(string name, Type type, bool readOnly);
  }
}
