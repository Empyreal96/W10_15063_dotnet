...
// Type: Microsoft.Xna.Framework.GamerServices.Stub.GSWriteLeaderboardEventArgs
...
{
  internal class GSWriteLeaderboardEventArgs : EventArgs
  {
    public int Gamer { get; private set; }

    public GSWriteLeaderboardEventArgs(int gamerHandle) => this.Gamer = gamerHandle;
  }
}
