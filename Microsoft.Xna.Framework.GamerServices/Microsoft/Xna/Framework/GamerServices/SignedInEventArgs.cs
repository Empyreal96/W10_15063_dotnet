...
// Type: Microsoft.Xna.Framework.GamerServices.SignedInEventArgs
...
namespace Microsoft.Xna.Framework.GamerServices
{
  public class SignedInEventArgs : EventArgs
  {
    ...
    public SignedInEventArgs(SignedInGamer gamer) => this.gamer = gamer != null ? gamer : throw new ArgumentNullException(nameof (gamer));
