...
// Type: Microsoft.Xna.Framework.GamerServices.PlayerState
...
namespace Microsoft.Xna.Framework.GamerServices
{
  ...
  {
    internal int Index;
    internal PlayerSignInState SignInState;
    internal string Gamertag;
    internal bool IsLive;
    internal bool IsGuest;
    internal GamerPrivilegeOptions Privileges;
    internal GameDefaults GameDefaults;
    internal int PartySize;

    internal bool IsSignedIn => (uint) this.SignInState > 0U;
  }
}
