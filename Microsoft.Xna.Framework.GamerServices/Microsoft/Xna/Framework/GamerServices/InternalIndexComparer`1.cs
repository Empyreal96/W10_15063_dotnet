...
// Type: Microsoft.Xna.Framework.GamerServices.InternalIndexComparer`1
...
namespace Microsoft.Xna.Framework.GamerServices
{
  ...
  internal struct InternalIndexComparer<T> : IComparer<T> where T : Gamer
  {
    public int Compare(T x, T y) => x.InternalIndex.CompareTo(y.InternalIndex);
  }
}
