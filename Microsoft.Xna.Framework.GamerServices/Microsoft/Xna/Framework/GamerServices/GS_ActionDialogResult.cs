...
// Type: Microsoft.Xna.Framework.GamerServices.GS_ActionDialogResult
...
{
  internal struct GS_ActionDialogResult
  {
    internal DismissedReason disReason;
    internal int iButtonPressed;
    internal int cEditFieldLength;
  }
}
