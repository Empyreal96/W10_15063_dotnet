...
// Type: GamerServices.Platforms.Web.LIVEnAchievementGranter
...
{
  internal class LIVEnAchievementGranter : LIVEnTask
  {
    private string achievementKey;

    public LIVEnAchievementGranter(string achievementKey) => this.achievementKey = achievementKey;

    public override void Do() => this.webService.AwardAchievement(this.achievementKey);
  }
}
