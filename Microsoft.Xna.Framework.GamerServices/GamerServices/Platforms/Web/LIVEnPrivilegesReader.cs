...
// Type: GamerServices.Platforms.Web.LIVEnPrivilegesReader
...
{
  internal class LIVEnPrivilegesReader : LIVEnTask
  {
    public override void Do()
    {
      try
      {
        int num = (int) this.webService.DownloadGamerPrivilegeOptions();
      }
      catch
      {
      }
