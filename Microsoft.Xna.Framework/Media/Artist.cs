...
namespace Microsoft.Xna.Framework.Media
{
  ...
  {
    internal static Artist Empty = new Artist();
    ...
    public SongCollection Songs
    {
      [SecuritySafeCritical] get
      {
        ...
        if (this.IsValidHandle && this.songs == SongCollection.Empty)
        {
          ...
          if (Helpers.Succeeded(UnsafeNativeMethods.MediaArtist_GetSongs(this.Handle, ref maxValue)))
    ...
    public AlbumCollection Albums
    {
      [SecuritySafeCritical] get
      {
        ...
        {
          uint maxValue = uint.MaxValue;
          if (Helpers.Succeeded(UnsafeNativeMethods.MediaArtist_GetAlbums(this.Handle, ref maxValue)))
    ...
    public static bool operator ==(Artist first, Artist second) => object.Equals((object) first, (object) second);
    ...
    public override bool Equals(object obj)
    {
      ...
      if (!equal)
      {
        ...
        if (this.IsValidHandle && artist != (Artist) null && artist.IsValidHandle)
        {
          int num = (int) UnsafeNativeMethods.MediaItem_IsEqual(this.Handle, artist.Handle, ref equal);
        }
      }
      return equal;
    }
    ...
    public bool Equals(Artist other)
    {
      ...
      if (!equal && this.IsValidHandle && (other != (Artist) null && other.IsValidHandle))
      {
