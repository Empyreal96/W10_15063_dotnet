...
// Type: Microsoft.Devices.Sensors.SensorNativeSampleHeader
...
{
  internal struct SensorNativeSampleHeader
  {
    public uint size;
    public long timeStamp;
    public uint sensorDataType;

    public DateTimeOffset TimeStamp => TimeUtil.ConvertGTCToSLDateTimeOffset(this.timeStamp);
  }
}
