...
// Type: Microsoft.Devices.Sensors.NotificationCallbackEventArgs
...
{
  internal class NotificationCallbackEventArgs : EventArgs
  {
    internal XPauseType PauseType { get; set; }
  }
}
