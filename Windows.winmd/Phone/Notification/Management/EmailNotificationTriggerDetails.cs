...
// Type: Windows.Phone.Notification.Management.EmailNotificationTriggerDetails
...
namespace Windows.Phone.Notification.Management
{
    ...
    IEmailNotificationTriggerDetails2
  {
    ...
    public extern string SenderName { [MethodImpl] get; }

    public extern string SenderAddress { [MethodImpl] get; }

    public extern EmailMessage EmailMessage { [MethodImpl] get; }
