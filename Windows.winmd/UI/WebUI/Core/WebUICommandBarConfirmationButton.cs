...
// Type: Windows.UI.WebUI.Core.WebUICommandBarConfirmationButton
...
namespace Windows.UI.WebUI.Core
{
  ...
  {
    [MethodImpl]
    public extern WebUICommandBarConfirmationButton();

    public extern string Text { [MethodImpl] get; [MethodImpl] set; }

    public extern event TypedEventHandler<WebUICommandBarConfirmationButton, WebUICommandBarItemInvokedEventArgs> ItemInvoked;
  }
}
