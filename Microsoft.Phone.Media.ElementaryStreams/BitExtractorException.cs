...
// Type: Microsoft.Phone.Media.ElementaryStreams.BitExtractorException
...
{
  public class BitExtractorException : Exception
  {
    public BitExtractorException(string message)
      : base(message)
    {
    }
  }
