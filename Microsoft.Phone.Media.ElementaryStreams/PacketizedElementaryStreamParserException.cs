...
// Type: Microsoft.Phone.Media.ElementaryStreams.PacketizedElementaryStreamParserException
...
{
  public class PacketizedElementaryStreamParserException : FormatException
  {
    public PacketizedElementaryStreamParserException(string message)
      : base(message)
    {
    }
  }
